...
class Tracer {
  constructor(runner, driver, reporters, plugins, options) {
    this.runner = runner
    this.driver = driver
...
module.exports = ({ runner, driver, reporters, plugins, config: { timeout }}) => {
  return new Tracer(runner, driver, reporters, plugins, { timeout })
}
